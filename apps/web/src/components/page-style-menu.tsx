                ...
                <div className="grid grid-cols-2 gap-1 mt-1">
                  {(
                    [
                      ...
                      { key: "code-block-zvj-1", label: "code-block zvj1" },
                      { key: "table-zvj-2", label: "table zvj2" },
                      { key: "callout-zvj-3", label: "callout zvj3" },
                      { key: "page-bg-zvj-4", label: "page-bg zvj4" },
                      { key: "heading-zvj-5", label: "heading zvj5" },
                      { key: "code-block-zvy-1", label: "code-block zvy1" },
                      { key: "table-zvy-2", label: "table zvy2" },
                      { key: "callout-zvy-3", label: "callout zvy3" },
                      { key: "page-bg-zvy-4", label: "page-bg zvy4" },
                      { key: "heading-zvy-5", label: "heading zvy5" },
                      { key: "code-block-zwn-1", label: "code-block zwn1" },
                      { key: "table-zwn-2", label: "table zwn2" },
                      { key: "callout-zwn-3", label: "callout zwn3" },
                      { key: "page-bg-zwn-4", label: "page-bg zwn4" },
                      { key: "heading-zwn-5", label: "heading zwn5" },
                      { key: "code-block-zxc-1", label: "code-block zxc1" },
                      { key: "table-zxc-2", label: "table zxc2" },
                      { key: "callout-zxc-3", label: "callout zxc3" },
                      { key: "page-bg-zxc-4", label: "page-bg zxc4" },
                      { key: "heading-zxc-5", label: "heading zxc5" },
                      { key: "code-block-zxr-1", label: "code-block zxr1" },
                      { key: "table-zxr-2", label: "table zxr2" },
                      { key: "callout-zxr-3", label: "callout zxr3" },
                      { key: "page-bg-zxr-4", label: "page-bg zxr4" },
                      { key: "heading-zxr-5", label: "heading zxr5" },
                      { key: "code-block-zyg-1", label: "code-block zyg1" },
                      { key: "table-zyg-2", label: "table zyg2" },
                      { key: "callout-zyg-3", label: "callout zyg3" },
                      { key: "page-bg-zyg-4", label: "page-bg zyg4" },
                      { key: "heading-zyg-5", label: "heading zyg5" },
                      { key: "code-block-zyv-1", label: "code-block zyv1" },
                      { key: "table-zyv-2", label: "table zyv2" },
                      { key: "callout-zyv-3", label: "callout zyv3" },
                      { key: "page-bg-zyv-4", label: "page-bg zyv4" },
                      { key: "heading-zyv-5", label: "heading zyv5" },
                      { key: "code-block-zzk-1", label: "code-block zzk1" },
                      { key: "table-zzk-2", label: "table zzk2" },
                      { key: "callout-zzk-3", label: "callout zzk3" },
                      { key: "page-bg-zzk-4", label: "page-bg zzk4" },
                      { key: "heading-zzk-5", label: "heading zzk5" },
                    ] as const
                  ).map((t) => (
                    <button
                      key={t.key}
