d4: { title: "AI · 백로그 개요 (한)", emoji: "🗺️", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_ici_d5: { title: "AI · 고객 설문 설계 (한)", emoji: "📝", color: "orange", aliases: ["ai", "doc", "korean"] },
                    translate_icx_l1: { title: "AI · 한국어 → 카렐리아어", emoji: "🔍", color: "red", aliases: ["ai", "translate", "karelian"] },
                    translate_icx_l2: { title: "AI · 한국어 → 잉구시어", emoji: "🎯", color: "purple", aliases: ["ai", "translate", "ingush"] },
                    translate_icx_l3: { title: "AI · 한국어 → 아바르어", emoji: "🧭", color: "default", aliases: ["ai", "translate", "avar"] },
                    translate_icx_l4: { title: "AI · 한국어 → 레즈기어", emoji: "🌐", color: "blue", aliases: ["ai", "translate", "lezgian"] },
                    translate_icx_l5: { title: "AI · 한국어 → 오세티아어", emoji: "💬", color: "green", aliases: ["ai", "translate", "ossetian"] },
                    doc_icx_d1: { title: "AI · 대외 발표 소개글 (한)", emoji: "🗺️", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_icx_d2: { title: "AI · 분기 사업 리뷰(QBR) (한)", emoji: "📝", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_icx_d3: { title: "AI · 장애 회고 (한)", emoji: "📘", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_icx_d4: { title: "AI · 뉴스레터 초안 (한)", emoji: "📙", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_icx_d5: { title: "AI · 면접 평가표 (한)", emoji: "📚", color: "red", aliases: ["ai", "doc", "korean"] },
                    translate_idm_l1: { title: "AI · 한국어 → 타지크어", emoji: "🌐", color: "purple", aliases: ["ai", "translate", "tajik"] },
                    translate_idm_l2: { title: "AI · 한국어 → 파슈토어", emoji: "💬", color: "default", aliases: ["ai", "translate", "pashto"] },
                    translate_idm_l3: { title: "AI · 한국어 → 발로치어", emoji: "🗺️", color: "blue", aliases: ["ai", "translate", "balochi"] },
                    translate_idm_l4: { title: "AI · 한국어 → 소라니쿠르드어", emoji: "📝", color: "green", aliases: ["ai", "translate", "kurdish sorani"] },
                    translate_idm_l5: { title: "AI · 한국어 → 신디어", emoji: "📘", color: "yellow", aliases: ["ai", "translate", "sindhi"] },
                    doc_idm_d1: { title: "AI · 기획 제안서 (한)", emoji: "📙", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_idm_d2: { title: "AI · 주간 업무 보고 (한)", emoji: "📚", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_idm_d3: { title: "AI · 회의록 (한)", emoji: "🌐", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_idm_d4: { title: "AI · 제품 요구사항 문서(PRD) (한)", emoji: "🖋️", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_idm_d5: { title: "AI · 고객 응대 스크립트 (한)", emoji: "📋", color: "purple", aliases: ["ai", "doc", "korean"] },
                    translate_ieb_l1: { title: "AI · 한국어 → 콘카니어", emoji: "📝", color: "default", aliases: ["ai", "translate", "konkani"] },
                    translate_ieb_l2: { title: "AI · 한국어 → 투루어", emoji: "📘", color: "blue", aliases: ["ai", "translate", "tulu"] },
                    translate_ieb_l3: { title: "AI · 한국어 → 산탈리어", emoji: "📙", color: "green", aliases: ["ai", "translate", "santali"] },
                    translate_ieb_l4: { title: "AI · 한국어 → 메이테이어", emoji: "📚", color: "yellow", aliases: ["ai", "translate", "meitei"] },
                    translate_ieb_l5: { title: "AI · 한국어 → 종카어", emoji: "🌐", color: "orange", aliases: ["ai", "translate", "dzongkha"] },
                    doc_ieb_d1: { title: "AI · 배포 노트 (한)", emoji: "🖋️", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_ieb_d2: { title: "AI · 채용 공고 (한)", emoji: "📋", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_ieb_d3: { title: "AI · 영업 제안 메일 (한)", emoji: "📈", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_ieb_d4: { title: "AI · 온보딩 가이드 (한)", emoji: "📊", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_ieb_d5: { title: "AI · 성과 평가 자기서술 (한)", emoji: "🧾", color: "default", aliases: ["ai", "doc", "korean"] },
                    translate_ieq_l1: { title: "AI · 한국어 → 네와르어", emoji: "📚", color: "blue", aliases: ["ai", "translate", "newar"] },
                    translate_ieq_l2: { title: "AI · 한국어 → 샨어", emoji: "🌐", color: "green", aliases: ["ai", "translate", "shan"] },
                    translate_ieq_l3: { title: "AI · 한국어 → 몽어", emoji: "🖋️", color: "yellow", aliases: ["ai", "translate", "hmong"] },
                    translate_ieq_l4: { title: "AI · 한국어 → 참어", emoji: "📋", color: "orange", aliases: ["ai", "translate", "cham"] },
                    translate_ieq_l5: { title: "AI · 한국어 → 아체어", emoji: "📈", color: "red", aliases: ["ai", "translate", "acehnese"] },
                    doc_ieq_d1: { title: "AI · OKR 초안 (한)", emoji: "📊", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_ieq_d2: { title: "AI · 기술 설계 문서 (한)", emoji: "🧾", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_ieq_d3: { title: "AI · 사용자 인터뷰 스크립트 (한)", emoji: "📜", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_ieq_d4: { title: "AI · 경쟁사 분석 (한)", emoji: "📣", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_ieq_d5: { title: "AI · 에스컬레이션 메일 (한)", emoji: "🔍", color: "blue", aliases: ["ai", "doc", "korean"] },
                    translate_iff_l1: { title: "AI · 한국어 → 미낭카바우어", emoji: "📋", color: "green", aliases: ["ai", "translate", "minangkabau"] },
                    translate_iff_l2: { title: "AI · 한국어 → 부기스어", emoji: "📈", color: "yellow", aliases: ["ai", "translate", "buginese"] },
                    translate_iff_l3: { title: "AI · 한국어 → 테투어", emoji: "📊", color: "orange", aliases: ["ai", "translate", "tetum"] },
                    translate_iff_l4: { title: "AI · 한국어 → 차모로어", emoji: "🧾", color: "red", aliases: ["ai", "translate", "chamorro"] },
                    translate_iff_l5: { title: "AI · 한국어 → 마셜제도어", emoji: "📜", color: "purple", aliases: ["ai", "translate", "marshallese"] },
                    doc_iff_d1: { title: "AI · 로드맵 개요 (한)", emoji: "📣", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iff_d2: { title: "AI · 스프린트 회고 (한)", emoji: "🔍", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iff_d3: { title: "AI · 의사결정 메모 (한)", emoji: "🎯", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_iff_d4: { title: "AI · FAQ 문서 (한)", emoji: "🧭", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_iff_d5: { title: "AI · 보도자료 (한)", emoji: "🌐", color: "green", aliases: ["ai", "doc", "korean"] },
                    translate_ifu_l1: { title: "AI · 한국어 → 길버트어", emoji: "🧾", color: "yellow", aliases: ["ai", "translate", "gilbertese"] },
                    translate_ifu_l2: { title: "AI · 한국어 → 피지어", emoji: "📜", color: "orange", aliases: ["ai", "translate", "fijian"] },
                    translate_ifu_l3: { title: "AI · 한국어 → 통가어", emoji: "📣", color: "red", aliases: ["ai", "translate", "tongan"] },
                    translate_ifu_l4: { title: "AI · 한국어 → 타히티어", emoji: "🔍", color: "purple", aliases: ["ai", "translate", "tahitian"] },
                    translate_ifu_l5: { title: "AI · 한국어 → 마르케사스어", emoji: "🎯", color: "default", aliases: ["ai", "translate", "marquesan"] },
                    doc_ifu_d1: { title: "AI · 기능 스펙 문서 (한)", emoji: "🧭", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_ifu_d2: { title: "AI · 해지/종료 안내문 (한)", emoji: "🌐", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_ifu_d3: { title: "AI · 가격 제안서 (한)", emoji: "💬", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_ifu_d4: { title: "AI · 백로그 개요 (한)", emoji: "🗺️", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_ifu_d5: { title: "AI · 고객 설문 설계 (한)", emoji: "📝", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    translate_igk_l1: { title: "AI · 한국어 → 라파누이어", emoji: "🔍", color: "orange", aliases: ["ai", "translate", "rapa nui"] },
                    translate_igk_l2: { title: "AI · 한국어 → 비슬라마어", emoji: "🎯", color: "red", aliases: ["ai", "translate", "bislama"] },
                    translate_igk_l3: { title: "AI · 한국어 → 톡피진", emoji: "🧭", color: "purple", aliases: ["ai", "translate", "tok pisin"] },
                    translate_igk_l4: { title: "AI · 한국어 → 히리모투어", emoji: "🌐", color: "default", aliases: ["ai", "translate", "hiri motu"] },
                    translate_igk_l5: { title: "AI · 한국어 → 팔라우어", emoji: "💬", color: "blue", aliases: ["ai", "translate", "palauan"] },
                    doc_igk_d1: { title: "AI · 대외 발표 소개글 (한)", emoji: "🗺️", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_igk_d2: { title: "AI · 분기 사업 리뷰(QBR) (한)", emoji: "📝", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_igk_d3: { title: "AI · 장애 회고 (한)", emoji: "📘", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_igk_d4: { title: "AI · 뉴스레터 초안 (한)", emoji: "📙", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_igk_d5: { title: "AI · 면접 평가표 (한)", emoji: "📚", color: "orange", aliases: ["ai", "doc", "korean"] },
                    translate_igz_l1: { title: "AI · 한국어 → 야페어", emoji: "🌐", color: "red", aliases: ["ai", "translate", "yapese"] },
                    translate_igz_l2: { title: "AI · 한국어 → 나와틀어", emoji: "💬", color: "purple", aliases: ["ai", "translate", "nahuatl"] },
                    translate_igz_l3: { title: "AI · 한국어 → 케추아어", emoji: "🗺️", color: "default", aliases: ["ai", "translate", "quechua"] },
                    translate_igz_l4: { title: "AI · 한국어 → 아이마라어", emoji: "📝", color: "blue", aliases: ["ai", "translate", "aymara"] },
                    translate_igz_l5: { title: "AI · 한국어 → 과라니어", emoji: "📘", color: "green", aliases: ["ai", "translate", "guarani"] },
                    doc_igz_d1: { title: "AI · 기획 제안서 (한)", emoji: "📙", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_igz_d2: { title: "AI · 주간 업무 보고 (한)", emoji: "📚", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_igz_d3: { title: "AI · 회의록 (한)", emoji: "🌐", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_igz_d4: { title: "AI · 제품 요구사항 문서(PRD) (한)", emoji: "🖋️", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_igz_d5: { title: "AI · 고객 응대 스크립트 (한)", emoji: "📋", color: "red", aliases: ["ai", "doc", "korean"] },
                    translate_iho_l1: { title: "AI · 한국어 → 마푸체어", emoji: "📝", color: "purple", aliases: ["ai", "translate", "mapuche"] },
                    translate_iho_l2: { title: "AI · 한국어 → 이눅티투트어", emoji: "📘", color: "default", aliases: ["ai", "translate", "greenlandic inuktitut"] },
                    translate_iho_l3: { title: "AI · 한국어 → 크리어", emoji: "📙", color: "blue", aliases: ["ai", "translate", "cree"] },
                    translate_iho_l4: { title: "AI · 한국어 → 오지브웨어", emoji: "📚", color: "green", aliases: ["ai", "translate", "ojibwe"] },
                    translate_iho_l5: { title: "AI · 한국어 → 나바호어", emoji: "🌐", color: "yellow", aliases: ["ai", "translate", "navajo"] },
                    doc_iho_d1: { title: "AI · 배포 노트 (한)", emoji: "🖋️", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_iho_d2: { title: "AI · 채용 공고 (한)", emoji: "📋", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_iho_d3: { title: "AI · 영업 제안 메일 (한)", emoji: "📈", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_iho_d4: { title: "AI · 온보딩 가이드 (한)", emoji: "📊", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iho_d5: { title: "AI · 성과 평가 자기서술 (한)", emoji: "🧾", color: "purple", aliases: ["ai", "doc", "korean"] },
                    translate_iid_l1: { title: "AI · 한국어 → 체로키어", emoji: "📚", color: "default", aliases: ["ai", "translate", "cherokee"] },
                    translate_iid_l2: { title: "AI · 한국어 → 하와이어", emoji: "🌐", color: "blue", aliases: ["ai", "translate", "hawaiian"] },
                    translate_iid_l3: { title: "AI · 한국어 → 마오리어", emoji: "🖋️", color: "green", aliases: ["ai", "translate", "maori"] },
                    translate_iid_l4: { title: "AI · 한국어 → 사모아어", emoji: "📋", color: "yellow", aliases: ["ai", "translate", "samoan"] },
                    translate_iid_l5: { title: "AI · 한국어 → 월로프어", emoji: "📈", color: "orange", aliases: ["ai", "translate", "wolof"] },
                    doc_iid_d1: { title: "AI · OKR 초안 (한)", emoji: "📊", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_iid_d2: { title: "AI · 기술 설계 문서 (한)", emoji: "🧾", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_iid_d3: { title: "AI · 사용자 인터뷰 스크립트 (한)", emoji: "📜", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iid_d4: { title: "AI · 경쟁사 분석 (한)", emoji: "📣", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iid_d5: { title: "AI · 에스컬레이션 메일 (한)", emoji: "🔍", color: "default", aliases: ["ai", "doc", "korean"] },
                    translate_iit_l1: { title: "AI · 한국어 → 밤바라어", emoji: "📋", color: "blue", aliases: ["ai", "translate", "bambara"] },
                    translate_iit_l2: { title: "AI · 한국어 → 풀라니어", emoji: "📈", color: "green", aliases: ["ai", "translate", "fula"] },
                    translate_iit_l3: { title: "AI · 한국어 → 티그리냐어", emoji: "📊", color: "yellow", aliases: ["ai", "translate", "tigrinya"] },
                    translate_iit_l4: { title: "AI · 한국어 → 암하라어", emoji: "🧾", color: "orange", aliases: ["ai", "translate", "amharic"] },
                    translate_iit_l5: { title: "AI · 한국어 → 소말리아어", emoji: "📜", color: "red", aliases: ["ai", "translate", "somali"] },
                    doc_iit_d1: { title: "AI · 로드맵 개요 (한)", emoji: "📣", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_iit_d2: { title: "AI · 스프린트 회고 (한)", emoji: "🔍", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iit_d3: { title: "AI · 의사결정 메모 (한)", emoji: "🎯", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iit_d4: { title: "AI · FAQ 문서 (한)", emoji: "🧭", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_iit_d5: { title: "AI · 보도자료 (한)", emoji: "🌐", color: "blue", aliases: ["ai", "doc", "korean"] },
                    translate_iji_l1: { title: "AI · 한국어 → 오로모어", emoji: "🧾", color: "green", aliases: ["ai", "translate", "oromo"] },
                    translate_iji_l2: { title: "AI · 한국어 → 쇼나어", emoji: "📜", color: "yellow", aliases: ["ai", "translate", "shona"] },
                    translate_iji_l3: { title: "AI · 한국어 → 세소토어", emoji: "📣", color: "orange", aliases: ["ai", "translate", "sesotho"] },
                    translate_iji_l4: { title: "AI · 한국어 → 츠와나어", emoji: "🔍", color: "red", aliases: ["ai", "translate", "tswana"] },
                    translate_iji_l5: { title: "AI · 한국어 → 키쿠유어", emoji: "🎯", color: "purple", aliases: ["ai", "translate", "kikuyu"] },
                    doc_iji_d1: { title: "AI · 기능 스펙 문서 (한)", emoji: "🧭", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iji_d2: { title: "AI · 해지/종료 안내문 (한)", emoji: "🌐", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iji_d3: { title: "AI · 가격 제안서 (한)", emoji: "💬", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_iji_d4: { title: "AI · 백로그 개요 (한)", emoji: "🗺️", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_iji_d5: { title: "AI · 고객 설문 설계 (한)", emoji: "📝", color: "green", aliases: ["ai", "doc", "korean"] },
                    translate_ijx_l1: { title: "AI · 한국어 → 루간다어", emoji: "🔍", color: "yellow", aliases: ["ai", "translate", "luganda"] },
                    translate_ijx_l2: { title: "AI · 한국어 → 말라가시어", emoji: "🎯", color: "orange", aliases: ["ai", "translate", "malagasy"] },
                    translate_ijx_l3: { title: "AI · 한국어 → 페로어", emoji: "🧭", color: "red", aliases: ["ai", "translate", "faroese"] },
                    translate_ijx_l4: { title: "AI · 한국어 → 그린란드어", emoji: "🌐", color: "purple", aliases: ["ai", "translate", "greenlandic"] },
                    translate_ijx_l5: { title: "AI · 한국어 → 룩셈부르크어", emoji: "💬", color: "default", aliases: ["ai", "translate", "luxembourgish"] },
                    doc_ijx_d1: { title: "AI · 대외 발표 소개글 (한)", emoji: "🗺️", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_ijx_d2: { title: "AI · 분기 사업 리뷰(QBR) (한)", emoji: "📝", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_ijx_d3: { title: "AI · 장애 회고 (한)", emoji: "📘", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_ijx_d4: { title: "AI · 뉴스레터 초안 (한)", emoji: "📙", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_ijx_d5: { title: "AI · 면접 평가표 (한)", emoji: "📚", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    translate_ikm_l1: { title: "AI · 한국어 → 로망슈어", emoji: "🌐", color: "orange", aliases: ["ai", "translate", "romansh"] },
                    translate_ikm_l2: { title: "AI · 한국어 → 사르데냐어", emoji: "💬", color: "red", aliases: ["ai", "translate", "sardinian"] },
                    translate_ikm_l3: { title: "AI · 한국어 → 프리울리아어", emoji: "🗺️", color: "purple", aliases: ["ai", "translate", "friulian"] },
                    translate_ikm_l4: { title: "AI · 한국어 → 옥시탄어", emoji: "📝", color: "default", aliases: ["ai", "translate", "occitan"] },
                    translate_ikm_l5: { title: "AI · 한국어 → 브르탕어", emoji: "📘", color: "blue", aliases: ["ai", "translate", "breton"] },
                    doc_ikm_d1: { title: "AI · 기획 제안서 (한)", emoji: "📙", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_ikm_d2: { title: "AI · 주간 업무 보고 (한)", emoji: "📚", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_ikm_d3: { title: "AI · 회의록 (한)", emoji: "🌐", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_ikm_d4: { title: "AI · 제품 요구사항 문서(PRD) (한)", emoji: "🖋️", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_ikm_d5: { title: "AI · 고객 응대 스크립트 (한)", emoji: "📋", color: "orange", aliases: ["ai", "doc", "korean"] },
                    translate_ilb_l1: { title: "AI · 한국어 → 코리시어", emoji: "📝", color: "red", aliases: ["ai", "translate", "cornish"] },
                    translate_ilb_l2: { title: "AI · 한국어 → 맨섬어", emoji: "📘", color: "purple", aliases: ["ai", "translate", "manx"] },
                    translate_ilb_l3: { title: "AI · 한국어 → 갈리시아어", emoji: "📙", color: "default", aliases: ["ai", "translate", "galician"] },
                    translate_ilb_l4: { title: "AI · 한국어 → 아스투리아스어", emoji: "📚", color: "blue", aliases: ["ai", "translate", "asturian"] },
                    translate_ilb_l5: { title: "AI · 한국어 → 아로마니아어", emoji: "🌐", color: "green", aliases: ["ai", "translate", "aromanian"] },
                    doc_ilb_d1: { title: "AI · 배포 노트 (한)", emoji: "🖋️", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_ilb_d2: { title: "AI · 채용 공고 (한)", emoji: "📋", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_ilb_d3: { title: "AI · 영업 제안 메일 (한)", emoji: "📈", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_ilb_d4: { title: "AI · 온보딩 가이드 (한)", emoji: "📊", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_ilb_d5: { title: "AI · 성과 평가 자기서술 (한)", emoji: "🧾", color: "red", aliases: ["ai", "doc", "korean"] },
                    translate_ilq_l1: { title: "AI · 한국어 → 라디노어", emoji: "📚", color: "purple", aliases: ["ai", "translate", "ladino"] },
                    translate_ilq_l2: { title: "AI · 한국어 → 타타르어", emoji: "🌐", color: "default", aliases: ["ai", "translate", "tatar"] },
                    translate_ilq_l3: { title: "AI · 한국어 → 바슈키르어", emoji: "🖋️", color: "blue", aliases: ["ai", "translate", "bashkir"] },
                    translate_ilq_l4: { title: "AI · 한국어 → 추바쉬어", emoji: "📋", color: "green", aliases: ["ai", "translate", "chuvash"] },
                    translate_ilq_l5: { title: "AI · 한국어 → 투바어", emoji: "📈", color: "yellow", aliases: ["ai", "translate", "tuvan"] },
                    doc_ilq_d1: { title: "AI · OKR 초안 (한)", emoji: "📊", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_ilq_d2: { title: "AI · 기술 설계 문서 (한)", emoji: "🧾", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_ilq_d3: { title: "AI · 사용자 인터뷰 스크립트 (한)", emoji: "📜", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_ilq_d4: { title: "AI · 경쟁사 분석 (한)", emoji: "📣", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_ilq_d5: { title: "AI · 에스컬레이션 메일 (한)", emoji: "🔍", color: "purple", aliases: ["ai", "doc", "korean"] },
                    translate_imf_l1: { title: "AI · 한국어 → 부리야트어", emoji: "📋", color: "default", aliases: ["ai", "translate", "buryat"] },
                    translate_imf_l2: { title: "AI · 한국어 → 칼믈크어", emoji: "📈", color: "blue", aliases: ["ai", "translate", "kalmyk"] },
                    translate_imf_l3: { title: "AI · 한국어 → 우드무르트어", emoji: "📊", color: "green", aliases: ["ai", "translate", "udmurt"] },
                    translate_imf_l4: { title: "AI · 한국어 → 마리어", emoji: "🧾", color: "yellow", aliases: ["ai", "translate", "mari"] },
                    translate_imf_l5: { title: "AI · 한국어 → 코미어", emoji: "📜", color: "orange", aliases: ["ai", "translate", "komi"] },
                    doc_imf_d1: { title: "AI · 로드맵 개요 (한)", emoji: "📣", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_imf_d2: { title: "AI · 스프린트 회고 (한)", emoji: "🔍", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_imf_d3: { title: "AI · 의사결정 메모 (한)", emoji: "🎯", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_imf_d4: { title: "AI · FAQ 문서 (한)", emoji: "🧭", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_imf_d5: { title: "AI · 보도자료 (한)", emoji: "🌐", color: "default", aliases: ["ai", "doc", "korean"] },
                    translate_imu_l1: { title: "AI · 한국어 → 에르지아어", emoji: "🧾", color: "blue", aliases: ["ai", "translate", "erzya"] },
                    translate_imu_l2: { title: "AI · 한국어 → 북사미어", emoji: "📜", color: "green", aliases: ["ai", "translate", "northern sami"] },
                    translate_imu_l3: { title: "AI · 한국어 → 카렐리아어", emoji: "📣", color: "yellow", aliases: ["ai", "translate", "karelian"] },
                    translate_imu_l4: { title: "AI · 한국어 → 잉구시어", emoji: "🔍", color: "orange", aliases: ["ai", "translate", "ingush"] },
                    translate_imu_l5: { title: "AI · 한국어 → 아바르어", emoji: "🎯", color: "red", aliases: ["ai", "translate", "avar"] },
                    doc_imu_d1: { title: "AI · 기능 스펙 문서 (한)", emoji: "🧭", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_imu_d2: { title: "AI · 해지/종료 안내문 (한)", emoji: "🌐", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_imu_d3: { title: "AI · 가격 제안서 (한)", emoji: "💬", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_imu_d4: { title: "AI · 백로그 개요 (한)", emoji: "🗺️", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_imu_d5: { title: "AI · 고객 설문 설계 (한)", emoji: "📝", color: "blue", aliases: ["ai", "doc", "korean"] },
                    translate_inj_l1: { title: "AI · 한국어 → 레즈기어", emoji: "🔍", color: "green", aliases: ["ai", "translate", "lezgian"] },
                    translate_inj_l2: { title: "AI · 한국어 → 오세티아어", emoji: "🎯", color: "yellow", aliases: ["ai", "translate", "ossetian"] },
                    translate_inj_l3: { title: "AI · 한국어 → 타지크어", emoji: "🧭", color: "orange", aliases: ["ai", "translate", "tajik"] },
                    translate_inj_l4: { title: "AI · 한국어 → 파슈토어", emoji: "🌐", color: "red", aliases: ["ai", "translate", "pashto"] },
                    translate_inj_l5: { title: "AI · 한국어 → 발로치어", emoji: "💬", color: "purple", aliases: ["ai", "translate", "balochi"] },
                    doc_inj_d1: { title: "AI · 대외 발표 소개글 (한)", emoji: "🗺️", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_inj_d2: { title: "AI · 분기 사업 리뷰(QBR) (한)", emoji: "📝", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_inj_d3: { title: "AI · 장애 회고 (한)", emoji: "📘", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_inj_d4: { title: "AI · 뉴스레터 초안 (한)", emoji: "📙", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_inj_d5: { title: "AI · 면접 평가표 (한)", emoji: "📚", color: "green", aliases: ["ai", "doc", "korean"] },
                    translate_iny_l1: { title: "AI · 한국어 → 소라니쿠르드어", emoji: "🌐", color: "yellow", aliases: ["ai", "translate", "kurdish sorani"] },
                    translate_iny_l2: { title: "AI · 한국어 → 신디어", emoji: "💬", color: "orange", aliases: ["ai", "translate", "sindhi"] },
                    translate_iny_l3: { title: "AI · 한국어 → 콘카니어", emoji: "🗺️", color: "red", aliases: ["ai", "translate", "konkani"] },
                    translate_iny_l4: { title: "AI · 한국어 → 투루어", emoji: "📝", color: "purple", aliases: ["ai", "translate", "tulu"] },
                    translate_iny_l5: { title: "AI · 한국어 → 산탈리어", emoji: "📘", color: "default", aliases: ["ai", "translate", "santali"] },
                    doc_iny_d1: { title: "AI · 기획 제안서 (한)", emoji: "📙", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iny_d2: { title: "AI · 주간 업무 보고 (한)", emoji: "📚", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_iny_d3: { title: "AI · 회의록 (한)", emoji: "🌐", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_iny_d4: { title: "AI · 제품 요구사항 문서(PRD) (한)", emoji: "🖋️", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_iny_d5: { title: "AI · 고객 응대 스크립트 (한)", emoji: "📋", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    translate_ion_l1: { title: "AI · 한국어 → 메이테이어", emoji: "📝", color: "orange", aliases: ["ai", "translate", "meitei"] },
                    translate_ion_l2: { title: "AI · 한국어 → 종카어", emoji: "📘", color: "red", aliases: ["ai", "translate", "dzongkha"] },
                    translate_ion_l3: { title: "AI · 한국어 → 네와르어", emoji: "📙", color: "purple", aliases: ["ai", "translate", "newar"] },
                    translate_ion_l4: { title: "AI · 한국어 → 샨어", emoji: "📚", color: "default", aliases: ["ai", "translate", "shan"] },
                    translate_ion_l5: { title: "AI · 한국어 → 몽어", emoji: "🌐", color: "blue", aliases: ["ai", "translate", "hmong"] },
                    doc_ion_d1: { title: "AI · 배포 노트 (한)", emoji: "🖋️", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_ion_d2: { title: "AI · 채용 공고 (한)", emoji: "📋", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_ion_d3: { title: "AI · 영업 제안 메일 (한)", emoji: "📈", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_ion_d4: { title: "AI · 온보딩 가이드 (한)", emoji: "📊", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_ion_d5: { title: "AI · 성과 평가 자기서술 (한)", emoji: "🧾", color: "orange", aliases: ["ai", "doc", "korean"] },
                    translate_ipc_l1: { title: "AI · 한국어 → 참어", emoji: "📚", color: "red", aliases: ["ai", "translate", "cham"] },
                    translate_ipc_l2: { title: "AI · 한국어 → 아체어", emoji: "🌐", color: "purple", aliases: ["ai", "translate", "acehnese"] },
                    translate_ipc_l3: { title: "AI · 한국어 → 미낭카바우어", emoji: "🖋️", color: "default", aliases: ["ai", "translate", "minangkabau"] },
                    translate_ipc_l4: { title: "AI · 한국어 → 부기스어", emoji: "📋", color: "blue", aliases: ["ai", "translate", "buginese"] },
                    translate_ipc_l5: { title: "AI · 한국어 → 테투어", emoji: "📈", color: "green", aliases: ["ai", "translate", "tetum"] },
                    doc_ipc_d1: { title: "AI · OKR 초안 (한)", emoji: "📊", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_ipc_d2: { title: "AI · 기술 설계 문서 (한)", emoji: "🧾", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_ipc_d3: { title: "AI · 사용자 인터뷰 스크립트 (한)", emoji: "📜", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_ipc_d4: { title: "AI · 경쟁사 분석 (한)", emoji: "📣", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_ipc_d5: { title: "AI · 에스컬레이션 메일 (한)", emoji: "🔍", color: "red", aliases: ["ai", "doc", "korean"] },
                    translate_ipr_l1: { title: "AI · 한국어 → 차모로어", emoji: "📋", color: "purple", aliases: ["ai", "translate", "chamorro"] },
                    translate_ipr_l2: { title: "AI · 한국어 → 마셜제도어", emoji: "📈", color: "default", aliases: ["ai", "translate", "marshallese"] },
                    translate_ipr_l3: { title: "AI · 한국어 → 길버트어", emoji: "📊", color: "blue", aliases: ["ai", "translate", "gilbertese"] },
                    translate_ipr_l4: { title: "AI · 한국어 → 피지어", emoji: "🧾", color: "green", aliases: ["ai", "translate", "fijian"] },
                    translate_ipr_l5: { title: "AI · 한국어 → 통가어", emoji: "📜", color: "yellow", aliases: ["ai", "translate", "tongan"] },
                    doc_ipr_d1: { title: "AI · 로드맵 개요 (한)", emoji: "📣", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_ipr_d2: { title: "AI · 스프린트 회고 (한)", emoji: "🔍", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_ipr_d3: { title: "AI · 의사결정 메모 (한)", emoji: "🎯", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_ipr_d4: { title: "AI · FAQ 문서 (한)", emoji: "🧭", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_ipr_d5: { title: "AI · 보도자료 (한)", emoji: "🌐", color: "purple", aliases: ["ai", "doc", "korean"] },
                    translate_iqg_l1: { title: "AI · 한국어 → 타히티어", emoji: "🧾", color: "default", aliases: ["ai", "translate", "tahitian"] },
                    translate_iqg_l2: { title: "AI · 한국어 → 마르케사스어", emoji: "📜", color: "blue", aliases: ["ai", "translate", "marquesan"] },
                    translate_iqg_l3: { title: "AI · 한국어 → 라파누이어", emoji: "📣", color: "green", aliases: ["ai", "translate", "rapa nui"] },
                    translate_iqg_l4: { title: "AI · 한국어 → 비슬라마어", emoji: "🔍", color: "yellow", aliases: ["ai", "translate", "bislama"] },
                    translate_iqg_l5: { title: "AI · 한국어 → 톡피진", emoji: "🎯", color: "orange", aliases: ["ai", "translate", "tok pisin"] },
                    doc_iqg_d1: { title: "AI · 기능 스펙 문서 (한)", emoji: "🧭", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_iqg_d2: { title: "AI · 해지/종료 안내문 (한)", emoji: "🌐", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_iqg_d3: { title: "AI · 가격 제안서 (한)", emoji: "💬", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iqg_d4: { title: "AI · 백로그 개요 (한)", emoji: "🗺️", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iqg_d5: { title: "AI · 고객 설문 설계 (한)", emoji: "📝", color: "default", aliases: ["ai", "doc", "korean"] },
                    translate_iqv_l1: { title: "AI · 한국어 → 히리모투어", emoji: "🔍", color: "blue", aliases: ["ai", "translate", "hiri motu"] },
                    translate_iqv_l2: { title: "AI · 한국어 → 팔라우어", emoji: "🎯", color: "green", aliases: ["ai", "translate", "palauan"] },
                    translate_iqv_l3: { title: "AI · 한국어 → 야페어", emoji: "🧭", color: "yellow", aliases: ["ai", "translate", "yapese"] },
                    translate_iqv_l4: { title: "AI · 한국어 → 나와틀어", emoji: "🌐", color: "orange", aliases: ["ai", "translate", "nahuatl"] },
                    translate_iqv_l5: { title: "AI · 한국어 → 케추아어", emoji: "💬", color: "red", aliases: ["ai", "translate", "quechua"] },
                    doc_iqv_d1: { title: "AI · 대외 발표 소개글 (한)", emoji: "🗺️", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_iqv_d2: { title: "AI · 분기 사업 리뷰(QBR) (한)", emoji: "📝", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iqv_d3: { title: "AI · 장애 회고 (한)", emoji: "📘", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iqv_d4: { title: "AI · 뉴스레터 초안 (한)", emoji: "📙", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_iqv_d5: { title: "AI · 면접 평가표 (한)", emoji: "📚", color: "blue", aliases: ["ai", "doc", "korean"] },
                    translate_irk_l1: { title: "AI · 한국어 → 아이마라어", emoji: "🌐", color: "green", aliases: ["ai", "translate", "aymara"] },
                    translate_irk_l2: { title: "AI · 한국어 → 과라니어", emoji: "💬", color: "yellow", aliases: ["ai", "translate", "guarani"] },
                    translate_irk_l3: { title: "AI · 한국어 → 마푸체어", emoji: "🗺️", color: "orange", aliases: ["ai", "translate", "mapuche"] },
                    translate_irk_l4: { title: "AI · 한국어 → 이눅티투트어", emoji: "📝", color: "red", aliases: ["ai", "translate", "greenlandic inuktitut"] },
                    translate_irk_l5: { title: "AI · 한국어 → 크리어", emoji: "📘", color: "purple", aliases: ["ai", "translate", "cree"] },
                    doc_irk_d1: { title: "AI · 기획 제안서 (한)", emoji: "📙", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_irk_d2: { title: "AI · 주간 업무 보고 (한)", emoji: "📚", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_irk_d3: { title: "AI · 회의록 (한)", emoji: "🌐", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_irk_d4: { title: "AI · 제품 요구사항 문서(PRD) (한)", emoji: "🖋️", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_irk_d5: { title: "AI · 고객 응대 스크립트 (한)", emoji: "📋", color: "green", aliases: ["ai", "doc", "korean"] },
                    translate_irz_l1: { title: "AI · 한국어 → 오지브웨어", emoji: "📝", color: "yellow", aliases: ["ai", "translate", "ojibwe"] },
                    translate_irz_l2: { title: "AI · 한국어 → 나바호어", emoji: "📘", color: "orange", aliases: ["ai", "translate", "navajo"] },
                    translate_irz_l3: { title: "AI · 한국어 → 체로키어", emoji: "📙", color: "red", aliases: ["ai", "translate", "cherokee"] },
                    translate_irz_l4: { title: "AI · 한국어 → 하와이어", emoji: "📚", color: "purple", aliases: ["ai", "translate", "hawaiian"] },
                    translate_irz_l5: { title: "AI · 한국어 → 마오리어", emoji: "🌐", color: "default", aliases: ["ai", "translate", "maori"] },
                    doc_irz_d1: { title: "AI · 배포 노트 (한)", emoji: "🖋️", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_irz_d2: { title: "AI · 채용 공고 (한)", emoji: "📋", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_irz_d3: { title: "AI · 영업 제안 메일 (한)", emoji: "📈", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_irz_d4: { title: "AI · 온보딩 가이드 (한)", emoji: "📊", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_irz_d5: { title: "AI · 성과 평가 자기서술 (한)", emoji: "🧾", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    translate_iso_l1: { title: "AI · 한국어 → 사모아어", emoji: "📚", color: "orange", aliases: ["ai", "translate", "samoan"] },
                    translate_iso_l2: { title: "AI · 한국어 → 월로프어", emoji: "🌐", color: "red", aliases: ["ai", "translate", "wolof"] },
                    translate_iso_l3: { title: "AI · 한국어 → 밤바라어", emoji: "🖋️", color: "purple", aliases: ["ai", "translate", "bambara"] },
                    translate_iso_l4: { title: "AI · 한국어 → 풀라니어", emoji: "📋", color: "default", aliases: ["ai", "translate", "fula"] },
                    translate_iso_l5: { title: "AI · 한국어 → 티그리냐어", emoji: "📈", color: "blue", aliases: ["ai", "translate", "tigrinya"] },
                    doc_iso_d1: { title: "AI · OKR 초안 (한)", emoji: "📊", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_iso_d2: { title: "AI · 기술 설계 문서 (한)", emoji: "🧾", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_iso_d3: { title: "AI · 사용자 인터뷰 스크립트 (한)", emoji: "📜", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_iso_d4: { title: "AI · 경쟁사 분석 (한)", emoji: "📣", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_iso_d5: { title: "AI · 에스컬레이션 메일 (한)", emoji: "🔍", color: "orange", aliases: ["ai", "doc", "korean"] },
                    translate_itd_l1: { title: "AI · 한국어 → 암하라어", emoji: "📋", color: "red", aliases: ["ai", "translate", "amharic"] },
                    translate_itd_l2: { title: "AI · 한국어 → 소말리아어", emoji: "📈", color: "purple", aliases: ["ai", "translate", "somali"] },
                    translate_itd_l3: { title: "AI · 한국어 → 오로모어", emoji: "📊", color: "default", aliases: ["ai", "translate", "oromo"] },
                    translate_itd_l4: { title: "AI · 한국어 → 쇼나어", emoji: "🧾", color: "blue", aliases: ["ai", "translate", "shona"] },
                    translate_itd_l5: { title: "AI · 한국어 → 세소토어", emoji: "📜", color: "green", aliases: ["ai", "translate", "sesotho"] },
                    doc_itd_d1: { title: "AI · 로드맵 개요 (한)", emoji: "📣", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_itd_d2: { title: "AI · 스프린트 회고 (한)", emoji: "🔍", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_itd_d3: { title: "AI · 의사결정 메모 (한)", emoji: "🎯", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_itd_d4: { title: "AI · FAQ 문서 (한)", emoji: "🧭", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_itd_d5: { title: "AI · 보도자료 (한)", emoji: "🌐", color: "red", aliases: ["ai", "doc", "korean"] },
                    translate_its_l1: { title: "AI · 한국어 → 츠와나어", emoji: "🧾", color: "purple", aliases: ["ai", "translate", "tswana"] },
                    translate_its_l2: { title: "AI · 한국어 → 키쿠유어", emoji: "📜", color: "default", aliases: ["ai", "translate", "kikuyu"] },
                    translate_its_l3: { title: "AI · 한국어 → 루간다어", emoji: "📣", color: "blue", aliases: ["ai", "translate", "luganda"] },
                    translate_its_l4: { title: "AI · 한국어 → 말라가시어", emoji: "🔍", color: "green", aliases: ["ai", "translate", "malagasy"] },
                    translate_its_l5: { title: "AI · 한국어 → 페로어", emoji: "🎯", color: "yellow", aliases: ["ai", "translate", "faroese"] },
                    doc_its_d1: { title: "AI · 기능 스펙 문서 (한)", emoji: "🧭", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_its_d2: { title: "AI · 해지/종료 안내문 (한)", emoji: "🌐", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_its_d3: { title: "AI · 가격 제안서 (한)", emoji: "💬", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_its_d4: { title: "AI · 백로그 개요 (한)", emoji: "🗺️", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_its_d5: { title: "AI · 고객 설문 설계 (한)", emoji: "📝", color: "purple", aliases: ["ai", "doc", "korean"] },
                    translate_iuh_l1: { title: "AI · 한국어 → 그린란드어", emoji: "🔍", color: "default", aliases: ["ai", "translate", "greenlandic"] },
                    translate_iuh_l2: { title: "AI · 한국어 → 룩셈부르크어", emoji: "🎯", color: "blue", aliases: ["ai", "translate", "luxembourgish"] },
                    translate_iuh_l3: { title: "AI · 한국어 → 로망슈어", emoji: "🧭", color: "green", aliases: ["ai", "translate", "romansh"] },
                    translate_iuh_l4: { title: "AI · 한국어 → 사르데냐어", emoji: "🌐", color: "yellow", aliases: ["ai", "translate", "sardinian"] },
                    translate_iuh_l5: { title: "AI · 한국어 → 프리울리아어", emoji: "💬", color: "orange", aliases: ["ai", "translate", "friulian"] },
                    doc_iuh_d1: { title: "AI · 대외 발표 소개글 (한)", emoji: "🗺️", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_iuh_d2: { title: "AI · 분기 사업 리뷰(QBR) (한)", emoji: "📝", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_iuh_d3: { title: "AI · 장애 회고 (한)", emoji: "📘", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iuh_d4: { title: "AI · 뉴스레터 초안 (한)", emoji: "📙", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iuh_d5: { title: "AI · 면접 평가표 (한)", emoji: "📚", color: "default", aliases: ["ai", "doc", "korean"] },
                    translate_iuw_l1: { title: "AI · 한국어 → 옥시탄어", emoji: "🌐", color: "blue", aliases: ["ai", "translate", "occitan"] },
                    translate_iuw_l2: { title: "AI · 한국어 → 브르탕어", emoji: "💬", color: "green", aliases: ["ai", "translate", "breton"] },
                    translate_iuw_l3: { title: "AI · 한국어 → 코리시어", emoji: "🗺️", color: "yellow", aliases: ["ai", "translate", "cornish"] },
                    translate_iuw_l4: { title: "AI · 한국어 → 맨섬어", emoji: "📝", color: "orange", aliases: ["ai", "translate", "manx"] },
                    translate_iuw_l5: { title: "AI · 한국어 → 갈리시아어", emoji: "📘", color: "red", aliases: ["ai", "translate", "galician"] },
                    doc_iuw_d1: { title: "AI · 기획 제안서 (한)", emoji: "📙", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_iuw_d2: { title: "AI · 주간 업무 보고 (한)", emoji: "📚", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iuw_d3: { title: "AI · 회의록 (한)", emoji: "🌐", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iuw_d4: { title: "AI · 제품 요구사항 문서(PRD) (한)", emoji: "🖋️", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_iuw_d5: { title: "AI · 고객 응대 스크립트 (한)", emoji: "📋", color: "blue", aliases: ["ai", "doc", "korean"] },
                    translate_ivl_l1: { title: "AI · 한국어 → 아스투리아스어", emoji: "📝", color: "green", aliases: ["ai", "translate", "asturian"] },
                    translate_ivl_l2: { title: "AI · 한국어 → 아로마니아어", emoji: "📘", color: "yellow", aliases: ["ai", "translate", "aromanian"] },
                    translate_ivl_l3: { title: "AI · 한국어 → 라디노어", emoji: "📙", color: "orange", aliases: ["ai", "translate", "ladino"] },
                    translate_ivl_l4: { title: "AI · 한국어 → 타타르어", emoji: "📚", color: "red", aliases: ["ai", "translate", "tatar"] },
                    translate_ivl_l5: { title: "AI · 한국어 → 바슈키르어", emoji: "🌐", color: "purple", aliases: ["ai", "translate", "bashkir"] },
                    doc_ivl_d1: { title: "AI · 배포 노트 (한)", emoji: "🖋️", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_ivl_d2: { title: "AI · 채용 공고 (한)", emoji: "📋", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_ivl_d3: { title: "AI · 영업 제안 메일 (한)", emoji: "📈", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_ivl_d4: { title: "AI · 온보딩 가이드 (한)", emoji: "📊", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_ivl_d5: { title: "AI · 성과 평가 자기서술 (한)", emoji: "🧾", color: "green", aliases: ["ai", "doc", "korean"] },
                    translate_iwa_l1: { title: "AI · 한국어 → 추바쉬어", emoji: "📚", color: "yellow", aliases: ["ai", "translate", "chuvash"] },
                    translate_iwa_l2: { title: "AI · 한국어 → 투바어", emoji: "🌐", color: "orange", aliases: ["ai", "translate", "tuvan"] },
                    translate_iwa_l3: { title: "AI · 한국어 → 부리야트어", emoji: "🖋️", color: "red", aliases: ["ai", "translate", "buryat"] },
                    translate_iwa_l4: { title: "AI · 한국어 → 칼믈크어", emoji: "📋", color: "purple", aliases: ["ai", "translate", "kalmyk"] },
                    translate_iwa_l5: { title: "AI · 한국어 → 우드무르트어", emoji: "📈", color: "default", aliases: ["ai", "translate", "udmurt"] },
                    doc_iwa_d1: { title: "AI · OKR 초안 (한)", emoji: "📊", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iwa_d2: { title: "AI · 기술 설계 문서 (한)", emoji: "🧾", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_iwa_d3: { title: "AI · 사용자 인터뷰 스크립트 (한)", emoji: "📜", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_iwa_d4: { title: "AI · 경쟁사 분석 (한)", emoji: "📣", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_iwa_d5: { title: "AI · 에스컬레이션 메일 (한)", emoji: "🔍", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    translate_iwp_l1: { title: "AI · 한국어 → 마리어", emoji: "📋", color: "orange", aliases: ["ai", "translate", "mari"] },
                    translate_iwp_l2: { title: "AI · 한국어 → 코미어", emoji: "📈", color: "red", aliases: ["ai", "translate", "komi"] },
                    translate_iwp_l3: { title: "AI · 한국어 → 에르지아어", emoji: "📊", color: "purple", aliases: ["ai", "translate", "erzya"] },
                    translate_iwp_l4: { title: "AI · 한국어 → 북사미어", emoji: "🧾", color: "default", aliases: ["ai", "translate", "northern sami"] },
                    translate_iwp_l5: { title: "AI · 한국어 → 카렐리아어", emoji: "📜", color: "blue", aliases: ["ai", "translate", "karelian"] },
                    doc_iwp_d1: { title: "AI · 로드맵 개요 (한)", emoji: "📣", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_iwp_d2: { title: "AI · 스프린트 회고 (한)", emoji: "🔍", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_iwp_d3: { title: "AI · 의사결정 메모 (한)", emoji: "🎯", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_iwp_d4: { title: "AI · FAQ 문서 (한)", emoji: "🧭", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_iwp_d5: { title: "AI · 보도자료 (한)", emoji: "🌐", color: "orange", aliases: ["ai", "doc", "korean"] },
                    translate_ixe_l1: { title: "AI · 한국어 → 잉구시어", emoji: "🧾", color: "red", aliases: ["ai", "translate", "ingush"] },
                    translate_ixe_l2: { title: "AI · 한국어 → 아바르어", emoji: "📜", color: "purple", aliases: ["ai", "translate", "avar"] },
                    translate_ixe_l3: { title: "AI · 한국어 → 레즈기어", emoji: "📣", color: "default", aliases: ["ai", "translate", "lezgian"] },
                    translate_ixe_l4: { title: "AI · 한국어 → 오세티아어", emoji: "🔍", color: "blue", aliases: ["ai", "translate", "ossetian"] },
                    translate_ixe_l5: { title: "AI · 한국어 → 타지크어", emoji: "🎯", color: "green", aliases: ["ai", "translate", "tajik"] },
                    doc_ixe_d1: { title: "AI · 기능 스펙 문서 (한)", emoji: "🧭", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_ixe_d2: { title: "AI · 해지/종료 안내문 (한)", emoji: "🌐", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_ixe_d3: { title: "AI · 가격 제안서 (한)", emoji: "💬", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_ixe_d4: { title: "AI · 백로그 개요 (한)", emoji: "🗺️", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_ixe_d5: { title: "AI · 고객 설문 설계 (한)", emoji: "📝", color: "red", aliases: ["ai", "doc", "korean"] },
                    translate_ixt_l1: { title: "AI · 한국어 → 파슈토어", emoji: "🔍", color: "purple", aliases: ["ai", "translate", "pashto"] },
                    translate_ixt_l2: { title: "AI · 한국어 → 발로치어", emoji: "🎯", color: "default", aliases: ["ai", "translate", "balochi"] },
                    translate_ixt_l3: { title: "AI · 한국어 → 소라니쿠르드어", emoji: "🧭", color: "blue", aliases: ["ai", "translate", "kurdish sorani"] },
                    translate_ixt_l4: { title: "AI · 한국어 → 신디어", emoji: "🌐", color: "green", aliases: ["ai", "translate", "sindhi"] },
                    translate_ixt_l5: { title: "AI · 한국어 → 콘카니어", emoji: "💬", color: "yellow", aliases: ["ai", "translate", "konkani"] },
                    doc_ixt_d1: { title: "AI · 대외 발표 소개글 (한)", emoji: "🗺️", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_ixt_d2: { title: "AI · 분기 사업 리뷰(QBR) (한)", emoji: "📝", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_ixt_d3: { title: "AI · 장애 회고 (한)", emoji: "📘", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_ixt_d4: { title: "AI · 뉴스레터 초안 (한)", emoji: "📙", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_ixt_d5: { title: "AI · 면접 평가표 (한)", emoji: "📚", color: "purple", aliases: ["ai", "doc", "korean"] },
                    translate_iyi_l1: { title: "AI · 한국어 → 투루어", emoji: "🌐", color: "default", aliases: ["ai", "translate", "tulu"] },
                    translate_iyi_l2: { title: "AI · 한국어 → 산탈리어", emoji: "💬", color: "blue", aliases: ["ai", "translate", "santali"] },
                    translate_iyi_l3: { title: "AI · 한국어 → 메이테이어", emoji: "🗺️", color: "green", aliases: ["ai", "translate", "meitei"] },
                    translate_iyi_l4: { title: "AI · 한국어 → 종카어", emoji: "📝", color: "yellow", aliases: ["ai", "translate", "dzongkha"] },
                    translate_iyi_l5: { title: "AI · 한국어 → 네와르어", emoji: "📘", color: "orange", aliases: ["ai", "translate", "newar"] },
                    doc_iyi_d1: { title: "AI · 기획 제안서 (한)", emoji: "📙", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_iyi_d2: { title: "AI · 주간 업무 보고 (한)", emoji: "📚", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_iyi_d3: { title: "AI · 회의록 (한)", emoji: "🌐", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iyi_d4: { title: "AI · 제품 요구사항 문서(PRD) (한)", emoji: "🖋️", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iyi_d5: { title: "AI · 고객 응대 스크립트 (한)", emoji: "📋", color: "default", aliases: ["ai", "doc", "korean"] },
                    translate_iyx_l1: { title: "AI · 한국어 → 샨어", emoji: "📝", color: "blue", aliases: ["ai", "translate", "shan"] },
                    translate_iyx_l2: { title: "AI · 한국어 → 몽어", emoji: "📘", color: "green", aliases: ["ai", "translate", "hmong"] },
                    translate_iyx_l3: { title: "AI · 한국어 → 참어", emoji: "📙", color: "yellow", aliases: ["ai", "translate", "cham"] },
                    translate_iyx_l4: { title: "AI · 한국어 → 아체어", emoji: "📚", color: "orange", aliases: ["ai", "translate", "acehnese"] },
                    translate_iyx_l5: { title: "AI · 한국어 → 미낭카바우어", emoji: "🌐", color: "red", aliases: ["ai", "translate", "minangkabau"] },
                    doc_iyx_d1: { title: "AI · 배포 노트 (한)", emoji: "🖋️", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_iyx_d2: { title: "AI · 채용 공고 (한)", emoji: "📋", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_iyx_d3: { title: "AI · 영업 제안 메일 (한)", emoji: "📈", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_iyx_d4: { title: "AI · 온보딩 가이드 (한)", emoji: "📊", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_iyx_d5: { title: "AI · 성과 평가 자기서술 (한)", emoji: "🧾", color: "blue", aliases: ["ai", "doc", "korean"] },
                    translate_izm_l1: { title: "AI · 한국어 → 부기스어", emoji: "📚", color: "green", aliases: ["ai", "translate", "buginese"] },
                    translate_izm_l2: { title: "AI · 한국어 → 테투어", emoji: "🌐", color: "yellow", aliases: ["ai", "translate", "tetum"] },
                    translate_izm_l3: { title: "AI · 한국어 → 차모로어", emoji: "🖋️", color: "orange", aliases: ["ai", "translate", "chamorro"] },
                    translate_izm_l4: { title: "AI · 한국어 → 마셜제도어", emoji: "📋", color: "red", aliases: ["ai", "translate", "marshallese"] },
                    translate_izm_l5: { title: "AI · 한국어 → 길버트어", emoji: "📈", color: "purple", aliases: ["ai", "translate", "gilbertese"] },
                    doc_izm_d1: { title: "AI · OKR 초안 (한)", emoji: "📊", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_izm_d2: { title: "AI · 기술 설계 문서 (한)", emoji: "🧾", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_izm_d3: { title: "AI · 사용자 인터뷰 스크립트 (한)", emoji: "📜", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_izm_d4: { title: "AI · 경쟁사 분석 (한)", emoji: "📣", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_izm_d5: { title: "AI · 에스컬레이션 메일 (한)", emoji: "🔍", color: "green", aliases: ["ai", "doc", "korean"] },
                    translate_jaa_l1: { title: "AI · 한국어 → 페로어", emoji: "🌐", color: "default", aliases: ["ai", "translate", "faroese"] },
                    translate_jaa_l2: { title: "AI · 한국어 → 그린란드어", emoji: "💬", color: "blue", aliases: ["ai", "translate", "greenlandic"] },
                    translate_jaa_l3: { title: "AI · 한국어 → 룩셈부르크어", emoji: "🗺️", color: "green", aliases: ["ai", "translate", "luxembourgish"] },
                    translate_jaa_l4: { title: "AI · 한국어 → 로망슈어", emoji: "📝", color: "yellow", aliases: ["ai", "translate", "romansh"] },
                    translate_jaa_l5: { title: "AI · 한국어 → 사르데냐어", emoji: "📘", color: "orange", aliases: ["ai", "translate", "sardinian"] },
                    doc_jaa_d1: { title: "AI · 기획 제안서 (한)", emoji: "📙", color: "yellow", aliases: ["ai", "doc", "korean"] },
                    doc_jaa_d2: { title: "AI · 주간 업무 보고 (한)", emoji: "📚", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_jaa_d3: { title: "AI · 회의록 (한)", emoji: "🌐", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_jaa_d4: { title: "AI · 제품 요구사항 문서(PRD) (한)", emoji: "🖋️", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_jaa_d5: { title: "AI · 고객 응대 스크립트 (한)", emoji: "📋", color: "default", aliases: ["ai", "doc", "korean"] },
                    translate_jap_l1: { title: "AI · 한국어 → 프리울리아어", emoji: "📝", color: "blue", aliases: ["ai", "translate", "friulian"] },
                    translate_jap_l2: { title: "AI · 한국어 → 옥시탄어", emoji: "📘", color: "green", aliases: ["ai", "translate", "occitan"] },
                    translate_jap_l3: { title: "AI · 한국어 → 브르탕어", emoji: "📙", color: "yellow", aliases: ["ai", "translate", "breton"] },
                    translate_jap_l4: { title: "AI · 한국어 → 코리시어", emoji: "📚", color: "orange", aliases: ["ai", "translate", "cornish"] },
                    translate_jap_l5: { title: "AI · 한국어 → 맨섬어", emoji: "🌐", color: "red", aliases: ["ai", "translate", "manx"] },
                    doc_jap_d1: { title: "AI · 배포 노트 (한)", emoji: "🖋️", color: "orange", aliases: ["ai", "doc", "korean"] },
                    doc_jap_d2: { title: "AI · 채용 공고 (한)", emoji: "📋", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_jap_d3: { title: "AI · 영업 제안 메일 (한)", emoji: "📈", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_jap_d4: { title: "AI · 온보딩 가이드 (한)", emoji: "📊", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_jap_d5: { title: "AI · 성과 평가 자기서술 (한)", emoji: "🧾", color: "blue", aliases: ["ai", "doc", "korean"] },
                    translate_jbe_l1: { title: "AI · 한국어 → 갈리시아어", emoji: "📚", color: "green", aliases: ["ai", "translate", "galician"] },
                    translate_jbe_l2: { title: "AI · 한국어 → 아스투리아스어", emoji: "🌐", color: "yellow", aliases: ["ai", "translate", "asturian"] },
                    translate_jbe_l3: { title: "AI · 한국어 → 아로마니아어", emoji: "🖋️", color: "orange", aliases: ["ai", "translate", "aromanian"] },
                    translate_jbe_l4: { title: "AI · 한국어 → 라디노어", emoji: "📋", color: "red", aliases: ["ai", "translate", "ladino"] },
                    translate_jbe_l5: { title: "AI · 한국어 → 타타르어", emoji: "📈", color: "purple", aliases: ["ai", "translate", "tatar"] },
                    doc_jbe_d1: { title: "AI · OKR 초안 (한)", emoji: "📊", color: "red", aliases: ["ai", "doc", "korean"] },
                    doc_jbe_d2: { title: "AI · 기술 설계 문서 (한)", emoji: "🧾", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_jbe_d3: { title: "AI · 사용자 인터뷰 스크립트 (한)", emoji: "📜", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_jbe_d4: { title: "AI · 경쟁사 분석 (한)", emoji: "📣", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_jbe_d5: { title: "AI · 에스컬레이션 메일 (한)", emoji: "🔍", color: "green", aliases: ["ai", "doc", "korean"] },
                    translate_jbt_l1: { title: "AI · 한국어 → 바슈키르어", emoji: "📋", color: "yellow", aliases: ["ai", "translate", "bashkir"] },
                    translate_jbt_l2: { title: "AI · 한국어 → 추바쉬어", emoji: "📈", color: "orange", aliases: ["ai", "translate", "chuvash"] },
                    translate_jbt_l3: { title: "AI · 한국어 → 투바어", emoji: "📊", color: "red", aliases: ["ai", "translate", "tuvan"] },
                    translate_jbt_l4: { title: "AI · 한국어 → 부리야트어", emoji: "🧾", color: "purple", aliases: ["ai", "translate", "buryat"] },
                    translate_jbt_l5: { title: "AI · 한국어 → 칼믈크어", emoji: "📜", color: "default", aliases: ["ai", "translate", "kalmyk"] },
                    doc_jbt_d1: { title: "AI · 로드맵 개요 (한)", emoji: "📣", color: "purple", aliases: ["ai", "doc", "korean"] },
                    doc_jbt_d2: { title: "AI · 스프린트 회고 (한)", emoji: "🔍", color: "default", aliases: ["ai", "doc", "korean"] },
                    doc_jbt_d3: { title: "AI · 의사결정 메모 (한)", emoji: "🎯", color: "blue", aliases: ["ai", "doc", "korean"] },
                    doc_jbt_d4: { title: "AI · FAQ 문서 (한)", emoji: "🧭", color: "green", aliases: ["ai", "doc", "korean"] },
                    doc_jbt_d5: { title: "AI · 보도자료 (한)", emoji: "🌐", color: "yellow", aliases: ["ai", "doc", "korean"] },
